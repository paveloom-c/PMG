...
%
\begin{align}
  V_{r,\text{mod}} &= V_{r,\text{rot}} + V_{r,\odot},\\
  \label{eq:v_r_rot}
...
\end{align}
%
где $ k = 4.7406 $ для $ r $ в кпк и $ \mu $ в мсд/год \cite{G.N.O.2016}.
...
\end{equation}
%
где $ k = 4.7406 $ для $ r $ в кпк и $ \mu $ в мсд/год = mas {yr}$^{-1}$, $ r $ [кпк] = $ 1 / \varpi $, где $ \varpi $ [мсд] --- параллакс, приведенный в каталоге.
...
\begin{figure}[p!]
  ...
  \makebox[0.9625\textwidth][l]{\subfloat{{\includegraphics[trim={0 0 1.80cm 0},clip]{All/objects/Plots by type/XZ}}}
...
\begin{figure}[p!]
  ...
  \makebox[0.9475\textwidth][l]{\subfloat{{\includegraphics[trim={0 0 1.56cm 0},clip]{HMSFRs/objects/XZ}}}
...
\begin{figure}[p!]
  ...
  \makebox[0.948\textwidth][l]{\subfloat{{\includegraphics[scale=1.1]{HMSFRs/n = 3/Conditional profile of A}}}
