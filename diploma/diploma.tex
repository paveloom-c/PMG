...
\begin{figure}[p!]
  ...
  \caption{Профили внутренней целевой функции (суммы квадратов относительных невязок), построенные по итоговым параметрам модели для объектов G037.42+01.51 (мазеры вблизи солнечного круга, $ n = 1$, слева сверху), G012.68-00.18 (выборка HMSFRs, $ n = 3 $, справа сверху), G035.02+00.34 (мазеры вблизи солнечного круга, $ n = 1 $, слева снизу) и G023.38+00.18 (выборка HMSFRs, $ n = 3 $, справа снизу). Желтой линией отмечено номинальное (указанное в каталоге) значение параллакса, зеленой --- приведенное.}
