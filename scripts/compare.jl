...
push!(tasks, @spawn begin
    ...
    p = scatter(
        μ_x_e[1:2:end],
        μ_x_e[2:2:end],
        L"\sigma_{\mu_x}, \, \mathrm{мсд/год} \; \mathrm{(VERA)}",
        L"\sigma_{\mu_x}, \, \mathrm{мсд/год} \; \mathrm{(Reid)}",
    )
...
push!(tasks, @spawn begin
    ...
    p = scatter(
        μ_y_e[1:2:end],
        μ_y_e[2:2:end],
        L"\sigma_{\mu_y}, \, \mathrm{мсд/год} \; \mathrm{(VERA)}",
        L"\sigma_{\mu_y}, \, \mathrm{мсд/год} \; \mathrm{(Reid)}",
    )
